...
$arr = find_all_files(__DIR__."/data/sal2");
//file_work(__DIR__.'/data/z.xlsx');
...
//    echo "사업장 : $place\n";
    ...
    $sp = $reader->load($src);
    $sp->setActiveSheetIndex(1);// 1번째 시트

    $title = $sp->getActiveSheet()->getCell('A1')->getValue();
//    echo "$title\n"; return;
    preg_match('/([0-9]{4})년\s*([0-9]{2})월(.*)/', $title, $match);
